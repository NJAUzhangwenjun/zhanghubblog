package cn.zhanghub.base.config.mybatis.plus;
...
public class CodeGenerator {
	 ...
	 * 作者
	 */
	private static final String AUTHOR = "张文军";

	/**
	 * 父包名
	 */
	private static final String PACKAGE_PARENT = "cn.zhanghub.base";
	...
	private static InjectionConfig getInjectionConfig() {
		...
		focList.add(new FileOutConfig(templatePath) {
			...
			public String outputFile(TableInfo tableInfo) {
				...
				return System.getProperty("user.dir") + "/src/main/resources/mapping/" + tableInfo.getEntityName()
